...
import java.io.*;
import java.net.*;
public class GameNow extends Applet implements MouseListener,MouseMotionListener,Serializable,Runnable
{
	Label l;
	int i,j,space=80;
	int x=650,y=120,n=5,p,q,flag=0,x1,y1,rx,ry,rb,sx,sy,sb,receive_flag=1,m_score=0,o_score=0,xx,yy;
...
/*<applet code="GameNow.class" width=1500 height=650>
</applet>*/